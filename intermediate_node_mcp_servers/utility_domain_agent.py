...
from leaf_node_services import SERVICES, UTILITY_DOMAIN_SERVICE_NAMES
...
SERVICES = {service_name: SERVICES[service_name] for service_name in UTILITY_DOMAIN_SERVICE_NAMES}
...
root_agent = Agent(
    ...
    name="utility_domain_router_agent",
    description=(
