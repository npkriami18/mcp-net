...
from leaf_node_services import SERVICES, DATA_DOMAIN_SERVICE_NAMES
...
SERVICES = {service_name: SERVICES[service_name] for service_name in DATA_DOMAIN_SERVICE_NAMES}
